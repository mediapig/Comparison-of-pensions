...
from plugins.china.pension_calculator import ChinaPensionCalculator
...
from plugins.singapore.plugin import SingaporePlugin
...
def create_pension_engine() -> PensionEngine:
    ...
    engine.register_calculator(SingaporePlugin())
