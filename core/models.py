...
class PensionResult:
    ...
    retirement_account_balance: float    # 退休当年账户余额（原始货币）
    ...
    def convert_to_currency(self, target_currency: str, converter) -> 'PensionResult':
        ...
        converted_balance = converter.convert(self.retirement_account_balance, self.original_currency, target_currency)

        return PensionResult(
            monthly_pension=converted_monthly,
            total_contribution=converted_contribution,
            total_benefit=converted_benefit,
            retirement_account_balance=converted_balance,
