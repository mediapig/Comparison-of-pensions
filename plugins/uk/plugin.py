...
from .config import UKConfig
from .tax_calculator import UKTaxCalculator
from .pension_calculator import UKPensionCalculator

class UKPlugin(BaseCountryPlugin):
    """英国插件"""
    ...
    def __init__(self):
        ...
        self.pension_calculator = UKPensionCalculator()
    ...
    def calculate_social_security(self,
        ...
        """计算国家保险缴费"""
        # 国家保险缴费率
        ni_rate = 0.12  # 12% 员工缴费
        employer_ni_rate = 0.138  # 13.8% 雇主缴费

        monthly_employee = monthly_salary * ni_rate
        monthly_employer = monthly_salary * employer_ni_rate
    ...
    def get_contribution_rates(self) -> Dict[str, float]:
        """获取国家保险缴费率"""
        return {
            "employee": 0.12,        # 员工缴费12%
            "employer": 0.138,       # 雇主缴费13.8%
            "total": 0.258           # 总缴费比例25.8%
        }
