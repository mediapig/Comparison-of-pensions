    ...
    def _generate_analysis_json(self, 
        ...
        return {
            ...
            "国家养老金缴费": {
                ...
                "雇主缴费率": "14.1%",
                "年度缴费": {
                    "员工缴费": self._format_decimals(national_pension.get('annual_employee_contribution', 0)),
                    "雇主缴费": self._format_decimals(national_pension.get('annual_employer_contribution', 0)),
                    "总缴费": self._format_decimals(national_pension.get('annual_total_contribution', 0))
                },
                "终身缴费": self._format_decimals(national_pension.get('total_contribution', 0))
            },
            
            "职业养老金缴费": {
                "员工缴费率": f"{occupational_pension.get('employee_rate', 0)*100:.1f}%",
                "雇主缴费率": f"{occupational_pension.get('employer_rate', 0)*100:.1f}%",
                "年度缴费": {
            ...
            "工作期总计": {
                ...
                "国家养老金缴费": self._format_decimals(national_pension.get('total_contribution', 0)),
